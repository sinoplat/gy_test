...
public class AdvicesActivity extends BaseActivity {
	...
	private void doSaveAdvicesinfo() {
		...
		final RollProgressbar rollProgressbar = CommonUtil.showProgressbarDialog(AdvicesActivity.this, "正在保存反馈信息", true);
		String jsonStr = "jsonstr={\"userCode\":\""+CommonUtil.getUserinfo2("userCode",this)+"\",\"mobileNo\":\""+CommonUtil.getUserinfo2("userPhoneNo",this)+"\","
...
//		Log.i("sysy", "SAVEADVICEINFOURL:"+url);
