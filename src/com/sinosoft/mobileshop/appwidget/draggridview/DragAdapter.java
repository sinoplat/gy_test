...
public class DragAdapter extends BaseAdapter implements DragGridBaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView update = (ImageView) convertView.findViewById(R.id.item_update);
		TextView mTextView = (TextView) convertView.findViewById(R.id.item_text);
		int app_status = (Integer) list.get(position).get("app_status");
...
//							Bitmap bitmap =BitmapFactory.decodeResource(view.getResources(),R.drawable.icon);
//							if(bitmap != null){
