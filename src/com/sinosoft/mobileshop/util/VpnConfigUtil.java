...
public class VpnConfigUtil {
	...
	private String vpnKey = "45665478";
	...
	private List<VpnBean> processData(JSONObject json) throws Exception {
		...
		String result1 = json.getString("VPNUserName");
		String result2 = json.getString("VPNPassword");
		String VPNUserName = Des.decryptDES(result1, vpnKey);
		String VPNPassword = Des.decryptDES(result2, vpnKey);
		...
		String result3 = json.getString("tianVPNUserName");
		String result4 = json.getString("tianVPNPassword");
		String tianVPNUserName = Des.decryptDES(result3, vpnKey);
		String tianVPNPassword = Des.decryptDES(result4, vpnKey);
