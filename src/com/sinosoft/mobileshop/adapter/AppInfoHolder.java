...
//		appInfoIcon.setImageResource(R.drawable.icon);
				...
				if(TDevice.is3GOpen() && "1".equals(downloadSet)) {
			        ...
			        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() { //设置确定按钮
			            ...
			            public void onClick(DialogInterface dialog, int which) {
			            	if(status == 0) { // 安装
								rollProgressbar = CommonUtil.showProgressbarDialog(itemView.getContext(), "正在获取下载资源", true);
...
//				+ "\","+ "\"PhoneNo\":\"" + "18831614093"
//				+ "\","+ "\"OS\":\"" + "1" 
//				+ "\","+ "\"CurrentVersion\":\"" + appVersionInfo.getApplicationVersionContent()
//				+ "\","+ "\"OptPackageName\":\"" +  appVersionInfo.getPackageName() 
//				+ "\","+ "\"OptUserCode\":\"" + "0000000000"
//				+ "\","+ "\"UserCode\":\"" + "0000000000"+ "\""
//				+ "}";
		String url = Constant.GETAPPVERSIONS + jsonStr;
		Log.i("sysy", "下载文件-------：url："+url);
